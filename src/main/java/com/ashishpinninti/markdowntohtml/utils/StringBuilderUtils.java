...
public class StringBuilderUtils {
	 ...
	 *         the specified <code>StringBuilder</code> object as determined by
	 *         comparing the corresponding string obtained by calling the
	 *         {@link StringBuilder#toString()} method.
	 */
	 ...
	 *         or is equal to this <code>StringBuilder</code> object as determined
	 *         by comparing the corresponding string obtained by calling the
	 *         {@link StringBuilder#toString()} method.
	 */
	...
	/**
	 * Tests if the substring of the specified <tt>StringBuilder</tt> beginning at
	 ...
	 *         index <code>offset</code>; <code>false</code> otherwise. The result
	 *         is <code>false</code> if <code>toffset</code> is negative or greater
	 *         than the length of this <code>StringBuilder</code> object; otherwise
